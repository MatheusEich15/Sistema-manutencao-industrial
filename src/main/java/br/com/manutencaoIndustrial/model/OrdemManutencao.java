...
public class OrdemManutencao {
    ...
    public OrdemManutencao(int id, int idMaquina, int idTecnico, LocalDate dataSolicitacao) {
        this.id = id;
        this.idMaquina = idMaquina;
        this.idTecnico = idTecnico;
        this.dataSolicitacao = dataSolicitacao;
    ...
    public String toString() {
        return "\nID: " + getId() + "\nID MÁQUINA: " + getIdMaquina() + "\nID TÉCNICO: " + getIdTecnico() + "\nDATA SOLICITAÇÃO: " + getDataSolicitacao() + "\n<>------------------<>";
    }
}
